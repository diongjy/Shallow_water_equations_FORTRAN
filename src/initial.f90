!this module to initialize the variables for the shallow water
...
subroutine init
    ...
    u(:,:,1) = 0.0
    v(:,:,1) = 0.0
    h(:,:,1) = H0 - perturb*exp(-(xx**2.0 + yy**2.0))  !creating a Gaussian bell on the surface
